...
P_ao = (C_sa*R_ao*R_sa*V_ao + ...
    C_sa*R_ao*R_tsa*V_ao + ...
    C_ao*R_sa*R_tao*V_sa + ...
    C_sa*R_sa*R_tsa*V_ao + ...
    C_ao*C_sa*P_sv*R_tao*R_tsa) / ...
    (C_ao*C_sa*(R_ao*R_sa + ...
    R_ao*R_tsa + ...
    R_sa*R_tao + ...
    R_sa*R_tsa + ...
...
if (P_ao < P_lv) && (V_lv > 0)
    P_sa = (C_ao*R_ao*R_a_valve*R_sa*V_sa + ...
        C_ao*R_ao*R_sa*R_tao*V_sa + ...
        C_ao*R_a_valve*R_sa*R_tao*V_sa + ...
        C_sa*R_a_valve*R_sa*R_tsa*V_ao + ...
        C_ao*C_sa*P_sv*R_ao*R_a_valve*R_tsa + ...
        C_ao*C_sa*P_sv*R_ao*R_tao*R_tsa + ...
        C_ao*C_sa*P_sv*R_a_valve*R_tao*R_tsa + ...
        C_ao*C_sa*P_lv*R_sa*R_tao*R_tsa) / ...
        (C_ao*C_sa*(R_ao*R_a_valve*R_sa + ...
        R_ao*R_a_valve*R_tsa + ...
        R_ao*R_sa*R_tao + ...
        R_ao*R_tao*R_tsa + ...
        R_a_valve*R_sa*R_tao + ...
        R_a_valve*R_sa*R_tsa + ...
        R_a_valve*R_tao*R_tsa + ...
        R_sa*R_tao*R_tsa));
      
    Q_a_valve = -(C_sa*R_ao*R_sa*V_ao + ...
        C_sa*R_ao*R_tsa*V_ao + ...
        C_ao*R_sa*R_tao*V_sa + ...
        C_sa*R_sa*R_tsa*V_ao - ...
        C_ao*C_sa*P_lv*R_ao*R_sa - ...
        C_ao*C_sa*P_lv*R_ao*R_tsa - ...
        C_ao*C_sa*P_lv*R_sa*R_tao - ...
        C_ao*C_sa*P_lv*R_sa*R_tsa - ...
        C_ao*C_sa*P_lv*R_tao*R_tsa + ...
        C_ao*C_sa*P_sv*R_tao*R_tsa) / ...
        (C_ao*C_sa*(R_ao*R_a_valve*R_sa + ...
        R_ao*R_a_valve*R_tsa + ...
        R_ao*R_sa*R_tao + ...
        ...
        R_a_valve*R_tao*R_tsa + ...
        R_sa*R_tao*R_tsa));
	Q_ao = -(C_ao*R_a_valve*R_sa*V_sa - ...
        C_sa*R_a_valve*R_sa*V_ao - ...
        C_sa*R_a_valve*R_tsa*V_ao + ...
        C_ao*R_sa*R_tao*V_sa + ...
        C_ao*C_sa*P_sv*R_a_valve*R_tsa - ...
        C_ao*C_sa*P_lv*R_sa*R_tao - ...
        C_ao*C_sa*P_lv*R_tao*R_tsa + ...
        C_ao*C_sa*P_sv*R_tao*R_tsa) / ...
        (C_ao*C_sa*(R_ao*R_a_valve*R_sa + ...
        ...
        R_a_valve*R_tao*R_tsa + ...
        R_sa*R_tao*R_tsa)); 
	Q_sa = (C_ao*R_ao*R_a_valve*V_sa + ...
        C_ao*R_ao*R_tao*V_sa + ...
        C_ao*R_a_valve*R_tao*V_sa + ...`
        C_sa*R_a_valve*R_tsa*V_ao - ...
        C_ao*C_sa*P_sv*R_ao*R_a_valve - ...
        C_ao*C_sa*P_sv*R_ao*R_tao - ...
        C_ao*C_sa*P_sv*R_a_valve*R_tao - ...
        C_ao*C_sa*P_sv*R_a_valve*R_tsa + ...
        C_ao*C_sa*P_lv*R_tao*R_tsa - ...
        C_ao*C_sa*P_sv*R_tao*R_tsa) / ...
        (C_ao*C_sa*(R_ao*R_a_valve*R_sa + ...
	...
	P_sa = (C_ao*R_ao*R_sa*V_sa + ...
        C_ao*R_sa*R_tao*V_sa + ...
        C_sa*R_sa*R_tsa*V_ao + ...
        C_ao*C_sa*P_sv*R_ao*R_tsa + ...
        C_ao*C_sa*P_sv*R_tao*R_tsa) / ...
        (C_ao*C_sa*(R_ao*R_sa + ...
        R_ao*R_tsa + ...
        R_sa*R_tao + ...
