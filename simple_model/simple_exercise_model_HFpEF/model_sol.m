function [outputs,rout,J] = model_sol(pars,theta,HFpEFdata,data)
...
init = initialconditions2(pars,HFpEFdata); 
...
[t,y] = ode15s(@model,[0 50*stim_per],init,options,pars,stim_per);
init_new = y(end,:); 
% 
% figure(100)
% plot(t,y(:,9),t,y(:,14))
...
% 
% figure(101)
% plot(tspan,sols(9,:),tspan,sols(14,:))
...
[rout,J] = calculatecost(outputs,theta,HFpEFdata,data); 
catch 
   outputs = []; 
   rout = 100; 
   J = rout'*rout; 
