...
fun = @(x) model_wrap_exercise(x,pars_opt,data); 
...
pars_opt_ex = parameters_opt(exercise_opt,pars_opt,theta); 
outputs = model_sol(pars_opt_ex,theta,data); 
