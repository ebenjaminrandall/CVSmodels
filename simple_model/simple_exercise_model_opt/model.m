...
function [dXdt,outputs] = model_exercise(t,x,pars,stim_per)
...
% Active forces
sigmaact_LV  = k_act * C_LV  * (SL_LV  - SLrest) * (SLo_LV  - SL_LV)  / LSEiso;
sigmaact_SEP = k_act * C_SEP * (SL_SEP - SLrest) * (SLo_SEP - SL_SEP) / LSEiso;
sigmaact_RV  = k_act * C_RV  * (SL_RV  - SLrest) * (SLo_RV  - SL_RV)  / LSEiso;
